...
htmlhelp_basename = 'dc-qiskit-qmldoc'
...
latex_documents = [
    (master_doc, 'dc-qiskit-qml.tex', 'dc-qiskit-qml Documentation',
...
man_pages = [
    (master_doc, 'dc-qiskit-qml', 'dc-qiskit-qml Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dc-qiskit-qml', 'dc-qiskit-qml Documentation',
     author, 'dc-qiskit-qml', 'One line description of project.',
     'Miscellaneous'),
]
